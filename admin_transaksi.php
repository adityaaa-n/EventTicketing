...
$query = "SELECT t.*, u.nama as nama_user, e.nama_event, p.waktu_bayar, p.bukti_pembayaran 
          FROM tickets t 
          JOIN users u ON t.user_id = u.user_id 
          JOIN events e ON t.event_id = e.event_id
          LEFT JOIN payment_logs p ON t.ticket_id = p.ticket_id
          ORDER BY FIELD(t.status, 'paid', 'confirmed', 'pending', 'rejected'), t.tanggal_beli DESC";
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($row['bukti_pembayaran'])): ?>
                                    <a href="uploads/<?= $row['bukti_pembayaran'] ?>" target="_blank" class="btn-lihat">
                            ...
                            <td>
                                <?php 
                                    ...
                                    $label = ($s=='paid') ? 'Menunggu' : ucfirst($s);
                                ?>
                            ...
                            <td>
                                <?php if ($row['status'] == 'paid'): ?>
                                    <form method="POST" class="action-form" onsubmit="return confirm('Terima pembayaran?');">
                                        ...
                                        <button type="submit" class="btn-act btn-acc" title="Terima">
                                    ...
                                    <form method="POST" class="action-form" onsubmit="return confirm('Tolak pembayaran?');">
                                        ...
                                        <button type="submit" class="btn-act btn-tolak" title="Tolak">
